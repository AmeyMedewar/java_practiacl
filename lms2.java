...
class Book {
    ...
    public Book(String bookName, String author, String isbn, int count) {
    ...
    public String toString() {
        return bookName + "," + author + "," + isbn + "," + count;
    }
...
class Library {
    ...
    public void addBooks(String bookName, String author, String isbn, int count) {
    ...
    if (!bookExists) {
        books.add(new Book(bookName, author, isbn, count));
    }
    ...
    public void returnBook(String userName, String isbn) {
        Book book = findBookByISBN(isbn);
        if (book != null) {
            // Increase count when returning the book
            book.setCount(book.getCount() + 1);
        ...
        do {
            ...
            switch (choice) {
                case 1:
                    ...
                    library.addBooks(title, author, isbn, count);
                    break;
                case 2:
